...
public class Tablero extends JFrame implements ActionListener{
   private Image imagen;
    ...
    public Tablero(){
        ...
        try{
            imagen = ImageIO.read(new File("src/main/java/com/cunoc/practica4/laminas/descarga.jpg"));
        }
        catch(IOException e){
    ...
    class FondoPanel extends JPanel{
        ...
        g.drawImage(imagen, 0, 10, 800, 600, null);
        
        }
       /* public void paint(Graphics g){
            imagen = new ImageIcon(getClass().getResource("src/main/java/com/cunoc/practica4/laminas/descarga.jpg")).getImage();
    ...
    public void objetos(){
        casillas = new Color (255,255,255);
        casilla2 = new Color (0,0, 0);
        fondo = new Color (0,118,3);
        jugador = new Color (255,0,0);
        jugador2 = new Color (0,255,13);
